            ...
            <div className='dashboard-section'>
                ...
                <div className='dashboard-main'>
                    <div className='top-module'>
                        <div className='dashboard-title'>Items Local Data Record</div>
                    </div>
                    ...
                    <div className='list-all-items'>
                        <div className='odd-list-items'>
                            ...
                            <div>
                                <div className='download-button' onClick={() => navigate('/purchasing/readOnlyLocal')}>
                                    Details
                                </div>
                            </div>
                        </div>
